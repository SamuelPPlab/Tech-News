...
def handle_writer_requests(SELECTOR):
    selector_list_css = [
        ...
        # "#js-main > div.z--container > article > div.tec--article__body-grid > div.z--pt-40.z--pb-24 > div.z--flex.z--items-center > div.tec--timestamp.tec--timestamp--lg > div.tec--timestamp__item.z--font-bold > a::text",
        # "#js-author-bar > div > p.z--m-none.z--truncate.z--font-bold > a::text",
        # "#js-main > div.z--container > article > div.tec--article__body-grid > div.z--pt-40.z--pb-24 > div.z--flex.z--items-center > div.tec--timestamp.tec--timestamp--lg > div.tec--timestamp__item.z--font-bold > a::text",
        # "#js-main > div.z--container > article > div.tec--article__body-grid > div.z--pt-40.z--pb-24 > div.z--flex.z--items-center > div.tec--timestamp.tec--timestamp--lg > div.tec--timestamp__item.z--font-bold > a::text"
        # "#js-main > div.z--container > article > div.tec--article__body-grid > div.z--pt-40.z--pb-24 > div.z--flex.z--items-center > div.tec--timestamp.tec--timestamp--lg > div.tec--timestamp__item.z--font-bold > a::text",
...
def handle_comments_count_requests(SELECTOR):
    selector_list_css = [
        ...
        "div.tec--toolbar__item button#js-comments-btn::attr(data-count)",
    ]
    comments_count = None
...
# link = "https://www.tecmundo.com.br/minha-serie/215302-she-hulk-renee-elise-goldsberry-entra-elenco-serie.htm"
